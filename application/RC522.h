...
#define MF522_RST_PIN       36//PC4
#define MF522_MISO_PIN      86//PF6
#define MF522_MOSI_PIN      87//PF7
#define MF522_SCK_PIN       85//PF5
#define MF522_NSS_PIN       84//PF4
 
#define RST_H                            os_pin_write(MF522_RST_PIN, PIN_HIGH)
#define RST_L                            os_pin_write(MF522_RST_PIN, PIN_LOW)
#define MOSI_H                           os_pin_write(MF522_MOSI_PIN, PIN_HIGH)
#define MOSI_L                           os_pin_write(MF522_MOSI_PIN, PIN_LOW)
#define SCK_H                            os_pin_write(MF522_SCK_PIN, PIN_HIGH)
#define SCK_L                            os_pin_write(MF522_SCK_PIN, PIN_LOW)
#define NSS_H                            os_pin_write(MF522_NSS_PIN, PIN_HIGH)
#define NSS_L                            os_pin_write(MF522_NSS_PIN, PIN_LOW)
#define READ_MISO                        os_pin_read(MF522_MISO_PIN)
