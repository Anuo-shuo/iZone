#include "my_device.h"
// os_pin_write(MF522_RST_PIN, PIN_HIGH);
// os_pin_read(MF522_MISO_PIN);
...
void my_device_init(void){
	...
	//os_pin_mode(LIGHT_SENSOR_A_PIN	, PIN_MODE_OUTPUT);
	//os_pin_mode(MQ2_SENSOR_A_PIN	, PIN_MODE_OUTPUT);
	//os_pin_mode(LIGHT_SENSOR_B_PIN	, PIN_MODE_INPUT);
}
